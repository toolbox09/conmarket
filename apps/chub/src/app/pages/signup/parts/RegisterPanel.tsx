...
export function RegisterPanel() {
    ...
    <Flex w='100%' h='100%' component={Center}  >
        <Flex direction={'column'} w={'400px'} mt={'80px'} mb={'80px'} gap={'24px'} >
          ...
          <Button leftSection={<IconMail size={24} />} w={'100%'} size={'md'} variant='outline' color='dark.3' >이메일 계정으로 계속하기</Button>
          <Divider w={'100%'}></Divider>
          <Flex justify={'space-between'} mx={'100px'} >
              <text>이미 계정이 있나요?</text>
              <Anchor href="" target="_blank" underline="always" style={{ color : 'black' }} >로그인</Anchor>
